...
const QMetaObject NetworkReply::staticMetaObject = {
    { &QNetworkReply::staticMetaObject, qt_meta_stringdata_NetworkReply.data,
      qt_meta_data_NetworkReply,  qt_static_metacall, nullptr, nullptr}
};


const QMetaObject *NetworkReply::metaObject() const
{
    return QObject::d_ptr->metaObject ? QObject::d_ptr->dynamicMetaObject() : &staticMetaObject;
}

void *NetworkReply::qt_metacast(const char *_clname)
{
    if (!_clname) return nullptr;
    if (!strcmp(_clname, qt_meta_stringdata_NetworkReply.stringdata0))
        return static_cast<void*>(this);
    return QNetworkReply::qt_metacast(_clname);
}

int NetworkReply::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
