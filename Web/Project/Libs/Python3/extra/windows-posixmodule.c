...
#ifndef MS_WINDOWS
#include "Modules/posixmodule.h"
#else
#include "Modules/winreparse.h"
#endif
...
#if defined(MS_WINDOWS) && (defined(__MINGW32__) || defined(__MINGW64__))
#define _MSC_VER 1
#undef HAVE_OPENDIR
#undef HAVE_FORK
#undef HAVE_GETEGID
...
#include "Modules/clinic/posixmodule.c.h"
